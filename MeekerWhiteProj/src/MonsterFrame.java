...
/*class ImagePan extends JPanel{
	...
	public ImagePan() throws IOException {
		image = ImageIO.read(new File("D:\\Workspace\\MeekerWhiteProj\\beholder.jpg"));	
	}
	@Override
	...
	public MonsterFrame() throws IOException {
		...
		JPanel imagePan = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				super.paintComponent(g);
				g.drawImage(image,0,0,380,280, Color.GRAY, null);
			}
		};
		...
		JTextArea  description = new JTextArea("This is just a test to see how this will fill on the display. With my luck this will probably fail.....",28,40);
