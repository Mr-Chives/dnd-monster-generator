...
public class MonsterFrame extends JFrame {
	public MonsterFrame() throws IOException {
		...
		JMenu okay = new JMenu("I warnned you. I am a master in the magical arts.");
		JMenuItem noodle = new JMenuItem("skidaddle skiddodle your dick is now a noodle");
		...
		JPanel imagePan = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				...
				g.drawImage(image,0,0,515,310, Color.GRAY, null);
			}
		};
		...
		// base values will be replaced with handed variable of the objects that are reperesented by each stat
