...
class ArmorClass implements Serializable {
	private AbilityScores as;
	private int ac;
 ...
 * @author Ryan
 */
class AbilityScores implements Serializable {
	...
	@Override
	public String toString() {
		return String.format("%d %d %d %d %d %d", asStr, asDex, asCon, asInt, asWis, asCha);
	}
}

class Actions implements Serializable {
...
class Languages implements Serializable {
...
class Senses implements Serializable {
	private AbilityScores as;
